...
-- logger.error("SIZES: rotation: {}, ObjectFlags: {}, ObjectData: {}, OutlineType: {}", sizeof(fallout::Rotation),
--         sizeof(fallout::ObjectFlags), sizeof(fallout::ObjectData), sizeof(fallout::OutlineType)
--         );

-- logger.error("OFFSETS: id: {}, elevation: {}, data: {}, pid: {}, owner: {}",
--     offsetof(fallout::Object, id),
--     offsetof(fallout::Object, elevation),
--     offsetof(fallout::Object, data),
--     offsetof(fallout::Object, pid),
--     offsetof(fallout::Object, owner)
-- );

-- fallout2-ce types
local header = io.open("../include/ffi/types.h", "r"):read("*a")
ffi.cdef(header)
