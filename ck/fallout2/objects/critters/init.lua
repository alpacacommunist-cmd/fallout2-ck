...
critters.mod_spawn_counters = {}

function critters.reset_spawn_counters(mod_id)
  local mod_counters = critters.mod_spawn_counters[mod_id]

  if mod_counters then critters.mod_spawn_counters[mod_id] = 0 end
end

function critters.generate_unique_tag(mod_id)
  local current_index = critters.mod_spawn_counters[mod_id] or 0

  critters.mod_spawn_counters[mod_id] = current_index + 1
