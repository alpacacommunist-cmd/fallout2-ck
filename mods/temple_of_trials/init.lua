...
events.on('onMapEnter', function()
  ...
  map.render.roof.tile(0x040005E5, 18693, 2)
  map.render.roof.tile(0x040005E5, 18694, 2)
  map.render.roof.tile(0x040005E5, 18893, 2)
  map.render.roof.tile(0x040005E5, 18894, 2)
  map.render.roof.tile(0x040005E5, 18895, 2)
  map.render.roof.tile(0x040005E5, 18896, 2)
  map.render.roof.tile(0x040005E5, 19093, 2)
  map.render.roof.tile(0x040005E5, 19094, 2)
  map.render.roof.tile(0x040005E5, 19095, 2)
